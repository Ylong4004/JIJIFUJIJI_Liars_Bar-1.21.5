#第一桌生成
#function liar_bar:1_op_command/c_table_generate with storage minecraft:jijifujiji_liat_bar c_table_position
#
#data modify storage jijifujiji_liat_bar c_table_position set value {x:整字,y:整字,z:整字}
#建议输入的
#say 生成结构
...
#data get storage minecraft:jijifujiji_liat_bar c_table_position.x
#data get storage minecraft:jijifujiji_liat_bar c_table_position.y
#data get storage minecraft:jijifujiji_liat_bar c_table_position.z

#data modify storage jijifujiji_liat_bar c_table_position set value "-2931 103 2121"
