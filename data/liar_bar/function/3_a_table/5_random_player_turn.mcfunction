...
############测试
#tellraw @a [{text:"a_table_playing ",color:"red"},{selector:"@a[tag=a_table_playing]",color:"red"},{text:"a_table_last   ",color:"gold"},{selector:"@a[tag=a_table_last]",color:"gold"},{text:"   【【这是5_random_player_turn后】】",color:"green"}]
############测试
