...
execute if entity @a[team=liar_bar_a_table,tag=a_table_2] as @a[team=liar_bar_a_table,tag=a_table_2] if score @s jijifujiji_liar_bar_variable matches 1.. run return run tag @s add a_table_playing
...
#execute if entity @a[team=liar_bar_a_table,tag=a_table_2] run return run tag @a[team=liar_bar_a_table,tag=a_table_2] add a_table_playing
