...
#清理玩家身上的枪
execute as @a[team=liar_bar_a_table,tag=a_table__shoot] run function liar_bar:3_a_table/8.1.9.1_open_shoot_target with storage minecraft:jijifujiji_liat_bar a_table_position
#创造枪然后保存主手物品


schedule function liar_bar:3_a_table/8.2_open_shoot 40t append
#2s选取开枪玩家运行开枪函数
...
#删除实体牌和枪
schedule function liar_bar:3_a_table/8.4.3_open_shoot_clear_gun 50t append
#延迟3秒后清理枪