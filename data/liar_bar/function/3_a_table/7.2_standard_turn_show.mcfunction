#随机选一个玩家然后让他出牌
$tellraw @s ["",\
{text:"【质疑】",color:"red",bold:true,click_event:{action:"run_command",command:"/trigger jijifujiji_liar_bar_a_table_join set 99"},hover_event:{action:"show_text",value:"开上家的牌！"}},\
