...
#删除身上的枪
execute if entity @s[tag=a_table_1,team=liar_bar_a_table] run bossbar remove minecraft:liar_bar_a_table_time_player1
execute if entity @s[tag=a_table_2,team=liar_bar_a_table] run bossbar remove minecraft:liar_bar_a_table_time_player2
execute if entity @s[tag=a_table_3,team=liar_bar_a_table] run bossbar remove minecraft:liar_bar_a_table_time_player3
execute if entity @s[tag=a_table_4,team=liar_bar_a_table] run bossbar remove minecraft:liar_bar_a_table_time_player4
#根据玩家的编号标签移除BOSS条
team leave @s
tag @s remove a_table_1
tag @s remove a_table_2
tag @s remove a_table_3
tag @s remove a_table_4
tag @s remove a_table_playing
tag @s remove a_table_last
tag @s remove a_table__shoot
#清除玩家的队伍信息和标签
kill @s
#杀死玩家
