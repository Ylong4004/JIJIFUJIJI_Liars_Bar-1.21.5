...
execute if score liar_bar_a_table_stage jijifujiji_liar_bar_variable matches 5 as @a[team=liar_bar_a_table,tag=a_table_playing] run function liar_bar:3_a_table/7.2_standard_turn_show with storage minecraft:jijifujiji_liat_bar a_table_position
