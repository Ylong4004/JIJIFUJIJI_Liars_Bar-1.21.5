...
execute if score liar_bar_a_table_number jijifujiji_liar_bar_variable matches 0..3 run scoreboard players add liar_bar_a_table_number jijifujiji_liar_bar_variable 1
#加入玩家数目+1
