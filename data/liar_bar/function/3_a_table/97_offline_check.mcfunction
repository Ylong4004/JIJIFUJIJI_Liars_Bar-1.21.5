...
tag @a[team=liar_bar_a_table] add liar_bar_a_table_online
#为队伍内的所有玩家增加标签tag=liar_bar_a_table_online
team remove liar_bar_a_table
#删除队伍
team add liar_bar_a_table "参加骗子酒馆A桌"
#重新创建队伍
team join liar_bar_a_table @a[tag=liar_bar_a_table_online]
#将标签tag=liar_bar_a_table_online的玩加进队伍
tag @a remove liar_bar_a_table_online
#删除标签
