...
{text:"【设置坐标】",color:"gold",bold:true,click_event:{action:"suggest_command",command:"/data modify storage jijifujiji_liat_bar a_table_position set value {x:number,y:number,z:number}"},hover_event:{action:"show_text",value:"请把里面的number改成第一桌的XYZ整数坐标"}},\
...
{text:"【设置坐标】",color:"gold",bold:true,click_event:{action:"suggest_command",command:"/data modify storage jijifujiji_liat_bar b_table_position set value {x:number,y:number,z:number}"},hover_event:{action:"show_text",value:"请把里面的number改成第二桌的XYZ整数坐标"}},\
...
{text:"【设置坐标】",color:"gold",bold:true,click_event:{action:"suggest_command",command:"/data modify storage jijifujiji_liat_bar c_table_position set value {x:number,y:number,z:number}"},hover_event:{action:"show_text",value:"请把里面的number改成第三桌的XYZ整数坐标"}},\
...
{text:"【设置坐标】",color:"gold",bold:true,click_event:{action:"suggest_command",command:"/data modify storage jijifujiji_liat_bar d_table_position set value {x:number,y:number,z:number}"},hover_event:{action:"show_text",value:"请把里面的number改成第四桌的XYZ整数坐标"}},\
...
{text:"【设置坐标】",color:"gold",bold:true,click_event:{action:"suggest_command",command:"/data modify storage jijifujiji_liat_bar e_table_position set value {x:number,y:number,z:number}"},hover_event:{action:"show_text",value:"请把里面的number改成第五桌的XYZ整数坐标"}},\
...
#tellraw @s [{text:"【获得货币】",color:"gold",bold:true,click_event:{action:"run_command",command:"/function liar_bar:1_op_command/3_gambling_mode_give"},hover_event:{action:"show_text",command:"给你发放用于赌博的货币。"}}]
