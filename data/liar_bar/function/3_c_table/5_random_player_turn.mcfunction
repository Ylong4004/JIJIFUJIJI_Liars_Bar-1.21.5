...
#在名字上显示剩余子弹
scoreboard players set liar_bar_c_table_stage jijifujiji_liar_bar_variable 4
#到4阶段
scoreboard players set liar_bar_c_table_tick jijifujiji_liar_bar_variable 0
#设置为初始tick0
scoreboard players set liar_bar_c_table_time jijifujiji_liar_bar_variable 45
#秒为45
scoreboard players set liar_bar_c_table_temp jijifujiji_liar_bar_variable 30
#临时变量=20
function liar_bar:3_c_table/5.0_random_player_turn_player with storage minecraft:jijifujiji_liat_bar c_table_position
#随机选择一个没有被淘汰的玩家出牌
tag @a[team=liar_bar_c_table] remove c_table_last
tag @a[team=liar_bar_c_table] remove c_table__shoot
...
#根据玩家来设定玩家
execute as @a[team=liar_bar_c_table,tag=c_table_playing] run function liar_bar:3_c_table/5.2_random_player_turn_show with storage minecraft:jijifujiji_liat_bar c_table_position
#给这个玩家发布聊天框按钮
scoreboard players enable @a[team=liar_bar_c_table,tag=c_table_playing] jijifujiji_liar_bar_c_table_click
#让玩家可以点按钮
