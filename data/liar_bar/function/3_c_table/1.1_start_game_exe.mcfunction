...
scoreboard objectives remove jijifujiji_liar_bar_c_table_join
scoreboard objectives remove jijifujiji_liar_bar_c_table_click
#删除计分板

#开始游戏的按钮，这将用于后续的传参
scoreboard objectives add jijifujiji_liar_bar_c_table_click trigger ["A桌的按键检测"]
#新建一个按键检测系统
scoreboard players set liar_bar_c_table_stage jijifujiji_liar_bar_variable 1
#到1阶段
scoreboard players set liar_bar_c_table_tick jijifujiji_liar_bar_variable 0
#设置为初始tick0
scoreboard players set liar_bar_c_table_time jijifujiji_liar_bar_variable 0
#秒为0
...
bossbar remove minecraft:liar_bar_c_table_time_player2
bossbar remove minecraft:liar_bar_c_table_time_player3
bossbar remove minecraft:liar_bar_c_table_time_player4
#删除游戏时间boss条
kill @e[type=minecraft:interaction,tag=c_table_1]
kill @e[type=minecraft:interaction,tag=c_table_2]
kill @e[type=minecraft:interaction,tag=c_table_3]
kill @e[type=minecraft:interaction,tag=c_table_4]
kill @e[type=minecraft:item_display,tag=liar_bar_c_table_card]
#删除实体
tag @a remove c_table_1
tag @a remove c_table_2
tag @a remove c_table_3
tag @a remove c_table_4
...
bossbar set jijifujiji_liar_bar_c_table_time visible true
$bossbar set jijifujiji_liar_bar_c_table_time players @a[x=$(x1),y=$(y1),z=$(z1),dx=18,dy=6,dz=18]
#设置boss条初始状态
team remove liar_bar_c_table
#删除队伍
team add liar_bar_c_table "参加骗子酒馆A桌"
#创建队伍

execute unless score gambling_mode jijifujiji_liar_bar_variable matches 1 run scoreboard players set @p jijifujiji_liar_bar_c_table_click 101
