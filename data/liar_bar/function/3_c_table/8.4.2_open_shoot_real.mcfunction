...
execute if entity @s[tag=c_table_3,team=liar_bar_c_table] run bossbar remove minecraft:liar_bar_c_table_time_player3
execute if entity @s[tag=c_table_4,team=liar_bar_c_table] run bossbar remove minecraft:liar_bar_c_table_time_player4
#根据玩家的编号标签移除BOSS条
team leave @s
tag @s remove c_table_1
tag @s remove c_table_2
tag @s remove c_table_3
tag @s remove c_table_4
tag @s remove c_table_playing
tag @s remove c_table_last
tag @s remove c_table__shoot
#清除玩家的队伍信息和标签
kill @s
#杀死玩家
