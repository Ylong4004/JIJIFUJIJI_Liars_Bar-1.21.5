...
execute if score liar_bar_c_table_stage jijifujiji_liar_bar_variable matches 4 as @a[team=liar_bar_c_table,tag=c_table_playing] run function liar_bar:3_c_table/5.2_random_player_turn_show with storage minecraft:jijifujiji_liat_bar c_table_position
execute if score liar_bar_c_table_stage jijifujiji_liar_bar_variable matches 5 as @a[team=liar_bar_c_table,tag=c_table_playing] run function liar_bar:3_c_table/7.2_standard_turn_show with storage minecraft:jijifujiji_liat_bar c_table_position
