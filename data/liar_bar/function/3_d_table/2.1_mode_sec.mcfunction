#每秒
#1阶段每秒一次
scoreboard players set liar_bar_d_table_temp jijifujiji_liar_bar_variable 40
#临时变量=40
...
execute if score liar_bar_d_table_time jijifujiji_liar_bar_variable matches 40 run function liar_bar:3_d_table/4_deal_cards with storage minecraft:jijifujiji_liat_bar d_table_position
#时间到了后启动发牌
