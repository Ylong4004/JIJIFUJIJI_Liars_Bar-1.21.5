...
#6阶段每秒一次
scoreboard players set liar_bar_d_table_temp jijifujiji_liar_bar_variable 110
#临时变量=110
...
#execute if score liar_bar_d_table_time jijifujiji_liar_bar_variable matches 110 run say 1
execute if score liar_bar_d_table_time jijifujiji_liar_bar_variable matches 110 run function liar_bar:3_d_table/4.0_deal_cards.exe with storage minecraft:jijifujiji_liat_bar d_table_position
#时间到了 运行重新发牌
