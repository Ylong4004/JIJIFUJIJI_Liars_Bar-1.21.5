...
execute if entity @a[team=liar_bar_d_table,tag=d_table_4] as @a[team=liar_bar_d_table,tag=d_table_4] if score @s jijifujiji_liar_bar_variable matches 1.. run return run tag @s add d_table_playing
...
#execute if entity @a[team=liar_bar_d_table,tag=d_table_4] run return run tag @a[team=liar_bar_d_table,tag=d_table_4] add d_table_playing
