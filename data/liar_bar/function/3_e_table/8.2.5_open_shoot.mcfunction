...
execute store result storage minecraft:jijifujiji_liat_bar e_table_position.bullet int 1 run scoreboard players get @s jijifujiji_liar_bar_bullet
#把剩余子弹数的计分板传入储存命令
...
function liar_bar:3_e_table/8.4_open_shoot_random with storage minecraft:jijifujiji_liat_bar e_table_position
#判定空弹和实弹
