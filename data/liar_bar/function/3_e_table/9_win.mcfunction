...
$execute if score e_table_mode jijifujiji_liar_bar_variable matches 2 run give @a[team=liar_bar_e_table] minecraft:prize_pottery_sherd[unbreakable={},minecraft:item_model="minecraft:jijifujiji_fantuan",minecraft:custom_name={text:"\u00A74饭团币"},minecraft:lore=[{text:"\u00A7f搏一搏，\u00A7e单车变摩托"}]] $(number)
