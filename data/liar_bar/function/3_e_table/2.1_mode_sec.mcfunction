#每秒
#1阶段每秒一次
scoreboard players set liar_bar_e_table_temp jijifujiji_liar_bar_variable 40
#临时变量=40
...
bossbar set jijifujiji_liar_bar_e_table_time name [{text:"已有",color:"yellow"},{"score":{"objective":"jijifujiji_liar_bar_variable","name":"liar_bar_e_table_number"},color:"gold",bold:true},{text:"人加入游戏，  ",color:"yellow"},{"score":{"objective":"jijifujiji_liar_bar_variable","name":"liar_bar_e_table_temp"},color:"gold",bold:true},{text:"s",color:"gold"}]
...
execute if score liar_bar_e_table_time jijifujiji_liar_bar_variable matches 40 run function liar_bar:3_e_table/4_deal_cards with storage minecraft:jijifujiji_liat_bar e_table_position
#时间到了后启动发牌
