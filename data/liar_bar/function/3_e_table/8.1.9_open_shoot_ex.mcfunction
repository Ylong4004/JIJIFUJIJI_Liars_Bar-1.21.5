...
execute as @a[tag=e_table_1,team=liar_bar_e_table] at @s run tp @s ~ ~ ~ 90 0
execute as @a[tag=e_table_2,team=liar_bar_e_table] at @s run tp @s ~ ~ ~ 180 0
execute as @a[tag=e_table_3,team=liar_bar_e_table] at @s run tp @s ~ ~ ~ -90 0
execute as @a[tag=e_table_4,team=liar_bar_e_table] at @s run tp @s ~ ~ ~ 0 0
#调整玩家的面向
execute as @a[tag=e_table_1,team=liar_bar_e_table] run ride @s mount @n[type=minecraft:interaction,tag=e_table_1]
execute as @a[tag=e_table_2,team=liar_bar_e_table] run ride @s mount @n[type=minecraft:interaction,tag=e_table_2]
...
schedule function liar_bar:3_e_table/8.2_open_shoot 40t append
#2s选取开枪玩家运行开枪函数
...
#删除实体牌和枪
schedule function liar_bar:3_e_table/8.4.3_open_shoot_clear_gun 50t append
#延迟3秒后清理枪