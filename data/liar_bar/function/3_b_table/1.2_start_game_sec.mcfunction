...
execute if score liar_bar_b_table_time jijifujiji_liar_bar_variable matches 20 run function liar_bar:3_b_table/99_over_game with storage minecraft:jijifujiji_liat_bar b_table_position
#如果到了时间就结束
