...
#5阶段每秒一次
scoreboard players set liar_bar_b_table_temp jijifujiji_liar_bar_variable 105
#临时变量=105
...
#execute if score liar_bar_b_table_time jijifujiji_liar_bar_variable matches 105 run #say 1
#execute if score liar_bar_b_table_time jijifujiji_liar_bar_variable matches 105 as @a[team=liar_bar_b_table,tag=b_table_playing] run function liar_bar:3_b_table/6.3_select_deal_time_over with storage minecraft:jijifujiji_liat_bar b_table_position
#时间到了 随便给你出牌

execute if score liar_bar_b_table_time jijifujiji_liar_bar_variable matches 105 if entity @a[team=liar_bar_b_table,tag=b_table_playing] as @a[team=liar_bar_b_table,tag=b_table_playing] run return run function liar_bar:3_b_table/6.3_select_deal_time_over with storage minecraft:jijifujiji_liat_bar b_table_position
#如果当前玩家存在，时间到了，自动给你随机出牌
execute if score liar_bar_b_table_time jijifujiji_liar_bar_variable matches 105 unless entity @a[team=liar_bar_b_table,tag=b_table_playing] run function liar_bar:3_b_table/96_offline_reset with storage minecraft:jijifujiji_liat_bar b_table_position
